  ...
  return (
    <section className=" text-white z-10 gap-[20px] flex w-full h-[450px] ">
      ...
      <div className="border border-white/10 bg-black/60 flex-col  basis-2/3 rounded-3xl p-[40px]">
        <h1 className="font-semibold text-5xl md:text-[32px]">{t("title")}</h1>
        <div className="flex gap-4 text-3xl md:text-[18px]">
          <p className="font-light  my-[20px]">github:</p>
          <Link
            href="https://github.com/Pinchedmon"
            className="font-light bg-orange px-3 rounded-3xl text-3xl md:text-[18px] my-[20px]"
          >
            {t("open")}
          </Link>
        </div>
        <div className="flex gap-4 text-3xl md:text-[18px]">
          ...
          <Link
            ...
            type="email"
            className="font-light bg-orange px-3 rounded-3xl text-3xl md:text-[18px] mb-[20px]"
          >
